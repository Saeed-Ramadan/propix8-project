    ...
    <footer className="bg-[#415a77] text-white pt-16 font-cairo" dir="rtl">
      <div className="max-w-7xl mx-auto px-6 md:px-16 grid grid-cols-1 md:grid-cols-4 gap-12 pb-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-300 text-center font-bold text-sm leading-relaxed opacity-90">
            Propix Eight Group for Real Estate Marketing & Property Solutions
          </p>
          <Link
            to="/units"
          ...
          >
            ...
            <ArrowLeft
              size={18}
              className="bg-[#415a77] text-white rounded-full p-0.5 group-hover:-translate-x-1 transition-transform"
            />
          </Link>
        </div>
        ...
        <div>
          <h3 className="text-xl font-bold mb-8 border-r-4 border-white pr-4 leading-none">
            روابط سريعة
          </h3>
        ...
        <div>
          ...
          <ul className="space-y-5 text-gray-300">
            <li className="flex items-center gap-4 group">
              ...
              >
                {settings?.site_phone || "01000000000"}
              </span>
            </li>
            <li className="flex items-center gap-4 group">
              <div className="p-2 bg-white/10 rounded-[0.5rem] group-hover:bg-white/20 transition-colors">
              ...
              <span className="group-hover:text-white transition-colors">
                {settings?.site_email || "info@company.com"}
              </span>
            </li>
            <li className="flex items-center gap-4 group">
              <div className="p-2 bg-white/10 rounded-[0.5rem] group-hover:bg-white/20 transition-colors">
              ...
              <span className="group-hover:text-white transition-colors">
                {settings?.site_address || "القاهرة، مصر"}
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col justify-between">
          <div>
            <h3 className="text-xl font-bold mb-6 border-r-4 border-white pr-4 leading-none">
              تابعنا
            </h3>
            <div className="flex gap-4 mb-10">
              {settings?.social_facebook && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 flex items-center justify-center bg-white/10 rounded-full hover:bg-[#1877F2] hover:scale-110 transition-all shadow-lg"
                >
                  <Facebook size={20} />
                </a>
              )}
              {settings?.social_instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 flex items-center justify-center bg-white/10 rounded-full hover:bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] hover:scale-110 transition-all shadow-lg"
                >
                  <Instagram size={20} />
                </a>
              )}
              {settings?.social_twitter && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 flex items-center justify-center bg-white/10 rounded-full hover:bg-black hover:scale-110 transition-all shadow-lg"
                >
                  <Twitter size={20} />
                </a>
              )}
      ...
      <div className="bg-[#1b263b]/50 py-5 text-center text-xs font-medium text-gray-400 border-t border-white/5">
        <p>
          © {new Date().getFullYear()} جميع الحقوق محفوظة لـ {siteName}
        </p>
      </div>
    </footer>
  );
