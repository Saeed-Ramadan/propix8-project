                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 bg-[#3E5879] text-white rounded-xl font-bold text-sm hover:bg-[#2c3e56] transition-all flex items-center gap-2"
                    >
                      <Eye size={16} />
                      تفاصيل
                    </button>
                    {booking.status === "pending" && (
                      <>
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-[#E02F2F] text-white rounded-xl font-bold text-sm hover:bg-red-600 transition-all flex items-center gap-2"
                        >
                          <Trash2 size={16} />
                          حذف
                        </button>
