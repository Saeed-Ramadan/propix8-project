    ...
    >
      ...
      >
        <div className="flex gap-2 w-full md:w-auto">
          <button
            onClick={() =>
              updateFilter(
                "offer_type",
                filters.offer_type === "sale" ? "rent" : "sale",
              )
            }
          ...
          >
            ...
            {filters.offer_type === "rent" ? "عرض للبيع" : "عرض للإيجار"}
          </button>
          ...
          <div className="relative border border-gray-200 rounded-md px-3 py-1.5 shadow-sm min-w-[140px]">
            ...
            <ChevronLeft
              size={10}
              className="absolute left-2 top-2.5 -rotate-90 text-gray-300"
            />
          </div>
        </div>
        ...
        <div className="relative flex-1 w-full">
          ...
          {loading && (
            <Loader2
              className="absolute left-10 top-2.5 animate-spin text-[#3E5879]"
              size={14}
            />
          )}
        </div>
        ...
        >
          ...
          <div className="space-y-6">
                ...
                {[
                  ...
                  <button
                    ...
                    onClick={() =>
                      updateFilter(
                        "development_status",
                        filters.development_status === st.id ? "" : st.id,
                      )
                    }
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <p className="font-black text-[#1F2937] text-[12px] mb-2 flex items-center gap-1">
                  <Calendar size={12} /> سنة البناء
                </p>
                <select
                ...
                {units.length > 0 ? (
                      ...
                      <div className="p-6 flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex justify-between items-center mt-4">
                          <div className="flex flex-col">
                            <span className="text-[#3E5879] text-xl font-black">
                              {formatPrice(unit.price)} ج.م
                            </span>
                            {unit.developer && (
                              <span className="text-[10px] text-gray-400 font-bold">
                                المطور: {unit.developer.name}
                              </span>
                            )}
                          </div>
                  ...
                  <div className="bg-white rounded-[2rem] py-20 text-center shadow-sm border border-dashed border-gray-200">
                    ...
                    <p className="text-gray-400 font-bold">
                      لا توجد وحدات متاحة تطابق خيارات التصفية الحالية
                    </p>
                    <button
                      onClick={resetFilters}
                      className="mt-4 text-[#3E5879] underline font-bold"
                    >
                      إعادة ضبط الفلاتر
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(pagination.last_page)].map((_, i) => {
                      ...
                      if (pageNum === 2 || pageNum === pagination.last_page - 1)
                        return (
                          <span key={pageNum} className="text-gray-300">
                            ...
                          </span>
                        );
                      return null;
